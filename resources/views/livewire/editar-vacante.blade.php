...
<form action="" method="post" class="md:w-1/2 space-y-5" wire:submit.prevent='editarVacante'>
    ...
    <div>
        ...
        <x-text-input id="ultimoDia" class="block mt-1 w-full" type="date" wire:model="ultimoDia"
            :value="old('ultimoDia')" />
    ...
    <div>
        ...
        <div class="my-5 w-30">
            ...
            {{-- el metodo asset() apunta a los archivos de la carpeta public,para que funcione se crea un link
            simbolico, para que el usuario solo pueda acceder a la carpeta public y no a los demas archivos,porque en la
            ruta el asset esta apuntando a la carpeta storage pero debemos hacer que el usuario solo pueda acceder a
            public.Para crear este link damos: php artisan storage:link --}}
